...
RomLoader::RomLoader(PWSTR filename) {
...
RomLoader::~RomLoader() {
	// TODO: The RomLoader should own this and be able to delete it.
	//delete prg_rom;
...
char *RomLoader::get_prg_rom() {
	return prg_rom;
}

char *RomLoader::get_chr_rom() {
	return chr_rom;
}

void RomLoader::printDebugInfo() {
